...
- Tạo nội dung ban đầu cho các working files dưới docs/changes/suggest-stock/ để phát triển tiếp ở các phase sau
...
3) Tạo/cập nhật các file sau dưới docs/changes/suggest-stock/
...
- Danh sách files được tạo/cập nhật dưới docs/changes/suggest-stock/
...
3) Tạo/cập nhật docs/changes/suggest-stock/impl-plan.md (nếu đã có bản đầu ở Phase 2 thì nuôi lớn nó)
...
Output:
- docs/changes/suggest-stock/impl-plan.md
...
Tasks:
1) Tạo/cập nhật docs/changes/suggest-stock/review-checklist.md (nếu đã có bản đầu từ Phase 2 thì nuôi lớn nó)
...
2) Tạo/cập nhật docs/changes/suggest-stock/self-review.md (nếu đã có template từ Phase 2 thì nuôi lớn nó)
...
@docs/changes/suggest-stock/spec-pack.md
@docs/changes/suggest-stock/impl-plan.md
@docs/changes/suggest-stock/review-checklist.md
(Ngoài ra tham chiếu implementation diffs nếu cần)

Tasks:
1) Tạo/cập nhật docs/changes/suggest-stock/test-plan.md (nếu đã có template từ Phase 2 thì nuôi lớn nó)
...
3) Nếu có thể, hãy chạy tests và tạo/cập nhật docs/changes/suggest-stock/test-results.md với kết quả
   - Commands đã chạy
   - Success / failure
